...
class CalcFuzzy:
    ...
    def __init__(self):
        ...
        #RULES
        rules = [
            ctrl.Rule(self.buildingType['pasywny'] &  self.wearWater['4 osoba'] &self.surface['dom_jednorodzinny'] &  self.isolation['doskonale'] , self.typeFurnance['pompa ciepla'] ),

            ctrl.Rule(self.buildingType['starebudownictwo'] | self.buildingType['70-85'] & self.wearWater['6 osoba'] |  self.wearWater['7 osoba'] | self.wearWater['8 osoba'] , self.typeFurnance['weglowy']  ),

            ctrl.Rule(self.buildingType['86-92']  & self.surface['dom_jednorodzinny'] &  self.surface['dom_jednorodzinny'] | self.surface['willa']  & self.isolation['slabo'] , self.typeFurnance['weglowy'] ) ,

            ctrl.Rule(self.buildingType['93-97']  | self.buildingType['98-07'] & self.surface['mieszkanie'] & self.isolation['srednio'] & self.zone['Strefa 1']  | self.zone['Strefa 2'] ,self.typeFurnance['gazowy'] ) ,

            ctrl.Rule(self.buildingType['energooszczedny'] | self.buildingType['niskoenegetyczny']  & self.isolation['dobrze']   , self.typeFurnance['pompa ciepla']  ),

            ctrl.Rule(self.buildingType['energooszczedny'] | self.buildingType['niskoenegetyczny'] & self.isolation[ 'srednio'] | self.isolation['slabo'], self.typeFurnance['gazowy']),

            ctrl.Rule(self.zone['Strefa 4'] | self.zone['Strefa 5'] &   self.wearWater['8 osoba'] |  self.wearWater['7 osoba'] & self.isolation['srednio'] ,  self.typeFurnance['weglowy'] ),

            ctrl.Rule(
                self.zone['Strefa 4'] | self.zone['Strefa 5'] & self.wearWater['8 osoba'] | self.wearWater['7 osoba'] &
                self.isolation['slabo'], self.typeFurnance['weglowy']),

            ctrl.Rule(
                self.buildingType['93-97'] | self.buildingType['98-07'] & self.surface['mieszkanie'] & self.isolation[
                    'srednio'] & self.zone['Strefa 1'] | self.zone['Strefa 2']  | self.zone['Strefa 3'] ,self.typeFurnance['gazowy']),
